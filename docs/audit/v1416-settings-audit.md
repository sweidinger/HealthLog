...
| ---------------------- | -------------------------------------------------------------- | ------------------------------------------------------ |
| Account page title     | `settings.sections.account.title`                              | `settings.profile` *(card heading inside the page)*    |
...
configuration**, but Thresholds also drives *insight* + *AI* outputs.
