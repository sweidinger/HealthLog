...
export function AdvancedSection() {
  ...
  // v1.25.1 (Q2-M3) — account deletion moved to the Account group
  // (`<AccountDeleteCard>` now renders under Settings → Profile & preferences).
  // It is an account-lifecycle action, not a data/privacy control. Research
  // mode + the data reset stay here.
  return (
