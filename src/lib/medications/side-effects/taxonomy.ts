...
> = {
  ...
  // Stimulant — activation (6)
  INSOMNIA: "STIMULANT_ACTIVATION",
  PALPITATIONS: "STIMULANT_ACTIVATION",
  RESTLESSNESS: "STIMULANT_ACTIVATION",
  TREMOR: "STIMULANT_ACTIVATION",
  TICS: "STIMULANT_ACTIVATION",
  SWEATING: "STIMULANT_ACTIVATION",
  // Stimulant — somatic (4)
  ...
  ANXIETY: "STIMULANT_MOOD",
  MOOD_SWINGS: "STIMULANT_MOOD",
  FATIGUE: "STIMULANT_MOOD",
};
 ...
 */
export const SIDE_EFFECT_ENTRY_COUNT = 37;
