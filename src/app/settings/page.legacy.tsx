// LEGACY: read-only reference for the v1.4 settings split. Delete after A2-rest lands.
//
// This file is the pre-A2 monolithic /settings page, preserved verbatim so the
// upcoming extraction PRs (A2-account, A2-about, A2-ai, A2-integrations,
// A2-notifications, A2-rest) can copy section-by-section into the new
// /settings/[section] routes. It is intentionally NOT a route — `page.tsx` (the
// active sibling) is a redirect, and Next.js only routes files literally named
// `page.tsx`. The default export was renamed to a non-default `LegacySettingsPage`
// so nothing accidentally imports it.
"use client";

// The legacy file is intentionally preserved verbatim and is NOT a route —
// disable the in-effect setState lint so the module compiles clean while
// section content is migrated. The new `/settings/[section]` routes follow
// the rule properly.
